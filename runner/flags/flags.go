...
func Temp() (Config, error) {
	return Config{Filters:providers.Filters{From:"", To:"", MatchStatusCodes:[]string(nil), MatchMimeTypes:[]string(nil), FilterStatusCodes:[]string(nil), FilterMimeTypes:[]string(nil)}, Proxy:"", Threads:0x1, Timeout:0x2d, Verbose:false, MaxRetries:0x5, IncludeSubdomains:false, RemoveParameters:false, Providers:[]string{"wayback", "commoncrawl", "otx", "urlscan"}, Blacklist:[]string{}, JSON:false, URLScan:URLScanConfig{Host:"", APIKey:""}, OTX:"", Outfile:""}, nil
}
